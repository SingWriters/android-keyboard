...
import org.singwriters.inputmethod.latin.common.UnicodeSurrogate;
import org.singwriters.inputmethod.latin.settings.SpacingAndPunctuations;
import org.singwriters.inputmethod.latin.utils.CapsModeUtils;
import org.singwriters.inputmethod.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See org.singwriters.inputmethod.latin.common.Constants.UnicodeSurrogate
